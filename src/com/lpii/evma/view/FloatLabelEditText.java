...
public class FloatLabelEditText extends LinearLayout {
	...
	private boolean mIsPersonName = false;
	private boolean mIsCapCharacters = false;
	...
	private void getAttributesFromXmlAndStoreLocally() {
		...
		mIsMultiLine = (attributesFromXmlLayout.getInt(R.styleable.FloatLabelEditText_inputType, 0) == 2);
		mIsEmail = (attributesFromXmlLayout.getInt(R.styleable.FloatLabelEditText_inputType, 0) == 3);
		mIsPersonName = (attributesFromXmlLayout.getInt(R.styleable.FloatLabelEditText_inputType, 0) == 4);
		mIsCapCharacters = (attributesFromXmlLayout.getInt(R.styleable.FloatLabelEditText_inputType, 0) == 5);
 		mIsnumber = (attributesFromXmlLayout.getInt(R.styleable.FloatLabelEditText_inputType, 0) == 6);
 
		System.out.println(attributesFromXmlLayout.getInt(R.styleable.FloatLabelEditText_inputType, 0));
	...
	private void setupEditTextView() {
		...
		if (mIsPersonName) {
			mEditTextView.setInputType(InputType.TYPE_TEXT_VARIATION_PERSON_NAME);
			mEditTextView.setTypeface(Typeface.DEFAULT);
		}
		if (mIsCapCharacters) {
			mEditTextView.setInputType(InputType.TYPE_TEXT_FLAG_CAP_CHARACTERS);
 		}
		if (mIsnumber) {
