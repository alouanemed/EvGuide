...
import com.lpii.evma.view.organizer.PagerSlidingTabStripEv.IconTabProvider;
...
public class QuickContactFragment extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tabs = (PagerSlidingTabStripEv) root.findViewById(R.id.tabs);
	...
	public class ContactPagerAdapter extends PagerAdapter implements IconTabProvider {
		...
		private final int[] ICONS = { R.drawable.ic_action_add_group, R.drawable.ic_action_done,
				R.drawable.ic_plusone_standard_off_client, R.drawable.ic_action_refresh };
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			v.setBackgroundResource(R.color.Color1);
